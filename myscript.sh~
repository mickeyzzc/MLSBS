...
SELECT_RUN_SCRIPT(){
	clear;
	SOURCE_SCRIPT system_base_set.sh
	...
	select var in "Initialize System" "Install nginx" "Install tomcat" "Install Mysql" "Setup firewall" "Install Puppet" "Exit";do
		case $var in
			...
			"Install nginx")
				SOURCE_SCRIPT nginx_install.sh
				NGINX_VAR && SELECT_NGINX_FUNCTION;;
			"Install tomcat")
				SOURCE_SCRIPT tomcat_install.sh
				TOMCAT_VAR && SELECT_TOMCAT_FUNCTION;;
			"Install Mysql")
				SOURCE_SCRIPT mysql_install.sh
